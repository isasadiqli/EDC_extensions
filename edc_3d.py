...
class Decoder3D(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(512, 128 * 8 * 8 * 8)
        self.deconv1 = nn.ConvTranspose3d(128, 64, kernel_size=2, stride=2, padding=0)
        self.deconv2 = nn.ConvTranspose3d(64, 32, kernel_size=2, stride=2, padding=0)
        self.deconv3 = nn.ConvTranspose3d(32, 1, kernel_size=2, stride=2, padding=0)
...
class EDC3D(nn.Module):
    def __init__(self):
        super(EDC3D, self).__init__()
